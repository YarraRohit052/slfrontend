    ...
    return (
        <div >
            <Card className="show__card">
                <p className="lighthouseroad__text">Seetharampuram</p>
            ...
            <Card className="show__card__total">
                <p className="para__lighthouse">Overall Street Data</p>
                <div className="row card__row">
